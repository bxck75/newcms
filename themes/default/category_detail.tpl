<div>
	...
	<table class="list">
		...
		<tr>
			...
			<td><input class="required" type="text" name="req_name" value="<?php echo stripslashes($this->category['category_name']); ?>" /></td>
		</tr>

		<tr>
			<td><?php echo $this->label_category_text; ?></td>
			<td><input class="required" type="text" name="req_text" value="<?php echo stripslashes($this->category['category_text']); ?>" /></td>
                        ...
                        <select class="element select medium" id="element_1" name="req_parent_category"> 
                            <?php foreach($this->parent_category_data as $parent_cat) { ?>
                                <?php if($parent_cat['category_name'] != ''){ ?>
                                    <?php if($this->category['category_id'] != $parent_cat['category_id']) { ?>
