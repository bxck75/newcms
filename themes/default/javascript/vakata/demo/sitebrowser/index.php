...
if(isset($_GET['operation'])) {
	//$fs = new tree(DB::get('mysql://kooy_kooy@127.0.0.1/newcms'), array('structure_table' => 'tree_struct', 'data_table' => 'tree_data', 'data' => array('nm')));
	$fs = new tree(DB::get('mysql://kooy_kooy:0o9i8u7y@localhost/newcms?charset=UTF8&persist=TRUE&timezone=Europe/Sofia'), array('structure_table' => 'tree_struct', 'data_table' => 'tree_data', 'data' => array('nm')));
	try {
		$rslt = null;
