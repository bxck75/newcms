<?php
//// create instance protocol://kooy_kooy:0o9i8u7y@localhost/newcms?charset=UTF8&persist=TRUE&timezone=Europe/Sofia
//$db2 = DB2::get('mysqli://kooy@127.0.0.1/newcms');
////$db2 = DB2::get('mysqli:kooy_kooy@localhost/newcms');
...
namespace vakata\database
{
	...
	{
		public $type		= null;
		public $username	= 'kooy_kooy';
		public $password	= '0o9i8u7y';
		public $database	= 'newcms';
		public $servername	= 'localhost';
		public $serverport	= '3306';
	...
	class mysql_driver extends ADriver
	{
		...
		public function __construct($settings) {
			parent::__construct($settings);
			if(!$this->settings->serverport) { $this->settings->serverport = 3306;$this->settings->username = "kooy_kooy"; $this->settings->password = "0o9i8u7y"; $this->settings->servername = "localhost";}
                }
			...
			$this->lnk = ($this->settings->persist) ? 
					...
					@mysql_connect("127.0.0.1:3306","kooy_kooy","0o9i8u7y");
//						$this->settings->servername.':'.$this->settings->serverport, 
//						$this->settings->username, 
//						$this->settings->password
//					);
